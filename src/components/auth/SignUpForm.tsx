          ...
          <div>
            ...
            <form>
              <div className="space-y-5">
                ...
                {/* <!-- Button --> */}
                <div>
                  <button className="shadow-theme-xs flex w-full items-center justify-center rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white transition hover:bg-brand-600">
                    Sign Up
                  </button>
                </div>
              </div>
